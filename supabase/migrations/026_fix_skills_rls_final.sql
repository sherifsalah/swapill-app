-- FINAL FIX FOR SKILLS RLS POLICIES - Use auth.uid() directly
...
COMMENT ON POLICY "Users can insert own skills" ON public.skills IS 'Allows users to insert skills using their auth user ID directly';
COMMENT ON POLICY "Users can update own skills" ON public.skills IS 'Allows users to update skills using their auth user ID directly';
COMMENT ON POLICY "Users can delete own skills" ON public.skills IS 'Allows users to delete skills using their auth user ID directly';
